...
<template>
  <div class="space-y-6 p-6">
    <header class="flex items-center justify-between">
      <h1 class="text-xl font-semibold capitalize text-highlighted">{{ type }} redirects</h1>
      <UButton variant="ghost" icon="i-lucide-arrow-left" :to="`/content/${type}`">Back</UButton>
    </header>
