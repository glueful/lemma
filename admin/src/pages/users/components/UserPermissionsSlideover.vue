...
<template>
  <USlideover
    v-model:open="open"
    :title="`Direct permissions — ${userDisplayName(user)}`"
    description="Permissions granted straight to this user, independent of their roles."
  ...
  >
    <template #body>
      ...
      <div v-else class="flex h-full min-h-96 flex-col gap-4">
